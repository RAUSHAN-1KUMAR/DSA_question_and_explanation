...
/*
Approach:- hashtable but without the use of map.
*/
...
int maxFrequencyElements(vector<int>& nums) 
{
    ...
    //finding maximum element in array to do hashing
    int max=0;
    ...
    //storing the count of occurence in new array 
