...
/*
Approach:- two pointer(little bit similar to mine);
    -- first convert all string into its ones count and store it in other vector, then apply two pointer on that vecotor to count the totalBeams.
