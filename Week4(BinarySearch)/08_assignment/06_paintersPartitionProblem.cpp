...
Dilpreet wants to paint his dog's home that has n boards with different lengths. the length of ith board is given by arr[i], where arr[] is an array of n intergers.He hired k painters for this work and each painters takes 1 unit time to paint 1 unit of the board.
...
/*
Approach:- same as book allocation problem, to understand the solution, understand the solution of book allocation problem because the question is very similar.
