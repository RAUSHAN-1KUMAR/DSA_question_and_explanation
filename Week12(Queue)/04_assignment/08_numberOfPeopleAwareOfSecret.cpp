...
// Question Type -> simulation i.e., queue m hi pop kerna h then push kerna h ya phir q m push ker rhe h then kuch operation ker rhe h
...
int peopleAwareOfSecret(int n, int delay, int forget)
{
    ...
    // {day, people_count}
    queue<pair<int,int>> forgetQ;// forgetQ is for, naye log jo add hue the isme, unke forget days ko check kerne ke liye, ager wo forget hote h to unko pop ker dengen
    queue<pair<int,int>> delayQ;// delayQ is for, naye log jo add hue the isme, wo kab active honge, active hone ke baad usko pop ker dengen
